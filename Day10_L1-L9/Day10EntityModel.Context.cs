...
namespace Day10_L1_L9
{
    ...
    public partial class Day10Entities_Model : DbContext
    {
        public Day10Entities_Model()
            : base("name=Day10Entities_Model")
        {
        }
        ...
        public virtual ObjectResult<GetCustomerByState_Result> GetCustomerByState(string state)
        {
            var stateParameter = state != null ?
                new ObjectParameter("state", state) :
                new ObjectParameter("state", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCustomerByState_Result>("GetCustomerByState", stateParameter);
        }
        ...
        public virtual ObjectResult<GetCustomerByState_Result1> GetCustomerByState0(string state)
        {
            var stateParameter = state != null ?
                new ObjectParameter("state", state) :
                new ObjectParameter("state", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCustomerByState_Result1>("GetCustomerByState0", stateParameter);
        }
    }
}
